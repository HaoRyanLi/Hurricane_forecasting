...
class TrainerModule:
    ...
    def create_functions(self):
        ...
        def train_step(i, args):
            ...
            batch = lax.dynamic_slice_in_dim(self.train_data, i, self.train_hparams['batch_size']+self.train_hparams['n_seq']-1)
    ...
    def init_optimizer(self, num_epochs):
        ...
        print(f"Total nums of trainging: {total_steps}")
        if self.lr_scheduler_name == 'constant':
            # We decrease the learning rate by a factor of 0.1 after 60% and 85% of the training
            lr_schedule = optax.piecewise_constant_schedule(init_value=init_value,boundaries_and_scales={int(total_steps*0.6): 0.1,
    ...
    def train_model(self, test_data, num_epochs=1000):
        self.num_steps_per_epoch = (self.train_data.shape[0]-self.train_hparams['n_seq']+1-self.train_hparams['batch_size']+1)
